...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: 'background.avif',   // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    position: 'center',      // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
    credit: {
      enable: false,         // Display the credit text of the banner image
      text: 'Blue Archive Memorial - Kei',              // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/TendouHayase',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Tendou Hayase',
  bio: 'email : me@tendouhayase.xyz',
  links: [
    {
      name: 'Steam',
      icon: 'fa6-brands:steam',
      url: 'https://steamcommunity.com/id/TendouHayase/',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/TendouHayase',
    },
  ],
}
